        ...
        <tbody style={{ backgroundColor: '#ddd'}}>
          ...
          {data.map((item) => (
            <tr key={item.id} style={{ border: '1px solid #ccc' }}>
              ...
              <td style={{ border: '1px solid #ccc', padding: '8px' }}> <Link to={item.route.props.path} className="important-link"> {item.food_name} </Link>  </td>
              <td style={{ border: '1px solid #ccc', padding: '8px' }}> <Link to={item.caroute.props.path} className="important-link"> {item.food_category}</Link></td>
